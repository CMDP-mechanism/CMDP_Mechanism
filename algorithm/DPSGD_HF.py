...
def DPSGD_HF(dataset_name,train_data, test_data, model, batch_size, lr, momentum, epsilon_budget,delta, C_t, sigma,use_scattering,input_norm,bn_noise_multiplier,num_groups,device,log_file):
